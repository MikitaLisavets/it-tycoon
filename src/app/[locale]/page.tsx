...
export default function Home() {
  ...
  // OnboardingModal handles its own translations internally if refactored, 
  // but currently we passed NO text to it in the original version?
  // Actually OnboardingModal has hardcoded text inside it. 
  // I also need to refactor OnboardingModal and WindowFrame.
  // But for this file, I need to translate the strings passed to children or rendered here.
    ...
    <div className={styles.container}>
      <WindowFrame title={t('me_and_my_computer')} width="650px" onHelpClick={() => setIsHelpOpen(true)}>
        ...
        <div className={styles.topBar}>
          <span>{t('date')}: 13/1/26</span>
          <span>{t('time')}: 7:00</span>
        </div>
