...
export const SOFTWARES: Record<SoftwareType, SoftwareItem[]> = {
    ...
    programs: [
        { id: "software_notepad", cost: { money: 100 }, category: 'programs', requirements: { system: 'winos_xp' }, duration: 5 },
        { id: "software_office", cost: { money: 500 }, category: 'programs', requirements: { system: 'winos_98' }, duration: 15 },
        ...
        { id: "software_3d_studio", cost: { money: 5000 }, category: 'programs', requirements: { system: 'winos_11' }, duration: 40 },
    ],
    antivirus: [
        { id: "software_antivirus", cost: { money: 300 }, category: 'antivirus', duration: 10 },
    ],
    games: [
        { id: "solitaire", category: 'games', duration: 2 },
    ]
};
