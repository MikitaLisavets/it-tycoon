...
export const SOFTWARES: Record<string, SoftwareItem[]> = {
    system: [
        ...
        { id: "winos_95", level: 1, price: 100, category: 'system' },
        { id: "winos_98", level: 2, price: 300, category: 'system' },
        { id: "winos_xp", level: 3, price: 800, category: 'system' },
        { id: "winos_7", level: 4, price: 1500, category: 'system' },
        { id: "winos_10", level: 5, price: 3000, category: 'system' },
    ],
    office: [
